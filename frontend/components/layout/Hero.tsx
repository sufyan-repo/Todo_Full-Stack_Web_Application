      ...
      >
        <div className="max-w-2xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-tight mb-4 text-foreground">
            Welcome back, <span className="text-black italic">{userName}</span>
          ...
          <p className="text-lg opacity-70 font-medium mb-6">
            You have <span className="font-black text-foreground">{pending}</span> tasks to complete. Get started by managing your to-do list.
          </p>
